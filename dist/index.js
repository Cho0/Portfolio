...
})({"kARYP":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
...
function getPosition() {
    ...
    slides.forEach((slide, index)=>{
        if (index === activeIndex) slide.style.transform = 'translateX(0)';
        else if (slide === prev) slide.style.transform = 'translateX(-100%)';
        else if (slide === next) slide.style.transform = 'translateX(100%)';
        else slide.style.transform = 'translate(100%)';
...
},{}]},["kARYP","29JuH"], "29JuH", "parcelRequire94c2")
